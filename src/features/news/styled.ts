...
export const ImageCardNew = styled.img`
  width: 100%;
  height: 40%;
  object-fit: cover;
...
export const TitleCardNew = styled.h3`
  font-size: 1.3rem;
  font-weight: bold;
  margin: 1rem auto;
  padding: 0 1rem;
...
export const DescriptionCardNew = styled.p`
  width: 100%;
  max-width: 100%;
  font-size: 1.2rem;
  margin: 0;
...
export const DateCardNew = styled.p`
  font-size: 0.9rem;
  margin: 0.3rem auto;
  width: 90%;
  text-align: right;
...
export const ButtonLectura = styled.button`
  width: 100%;
  border: none;
  color: #fff;
  font-size: 1rem;
